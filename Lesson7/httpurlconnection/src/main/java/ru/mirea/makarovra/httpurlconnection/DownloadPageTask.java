...
public class DownloadPageTask extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            binding.timezone.setText("Часовой пояс:" + responseJson.getString("timezone"));

            String[] location = responseJson.getString("loc").split(",");
            new DownloadWeather(binding).execute(
                    "https://api.open-meteo.com/v1/forecast?latitude="+location[0]+"&longitude="+location[1]+"&current_weather=true");
            Log.d(MainActivity.class.getSimpleName(), "Response: " + "https://api.open-meteo.com/v1/forecast?latitude="+location[0]+"&longitude="+location[1]+"&current_weather=true");
